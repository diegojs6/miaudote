...
class AnimalsState extends Equatable {
  ...
  AnimalsState.inital() : this._(AnimalsStatus.loading, [], null);

  AnimalsState loading() => AnimalsState._(AnimalsStatus.loading, getAnimals, messageError);

  AnimalsState ready(List<Animals> animals) => AnimalsState._(AnimalsStatus.ready, animals, messageError);
